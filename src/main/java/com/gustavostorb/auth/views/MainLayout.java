package com.gustavostorb.auth.views;


import com.gustavostorb.auth.components.appnav.AppNav;
import com.gustavostorb.auth.components.appnav.AppNavItem;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("Projeto Integrador 2022");
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Swagger", SwaggerView.class, "la la-file"));
